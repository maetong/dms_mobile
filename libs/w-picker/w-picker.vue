  ...
  <view class="w-picker" :key="createKey" :data-key="createKey">
    ...
    <view class="w-picker-cnt" :class="{ visible: visible }">
      <view class="w-picker-header" @touchmove.stop.prevent catchtouchmove="true">
        ...
        <view class="w-picker-btn">请选择</view>
        <image
          @click="pickerCancel"
          class="w-picker-close-icon"
          src="/static/image/popup-close.svg"
          mode="scaleToFill"
        ></image>
      </view>
      <date-picker
      ...
      <linkage-picker
        ...
        @touchend="touchEnd"
      ></linkage-picker>
      <view class="w-picker-bottom">
        <m-button class="demo-btn" type="primary" @click.native="pickerConfirm">确定</m-button>
      </view>
    </view>
  </view>
</template>
